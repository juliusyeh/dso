...
#include "src/util/globalCalib.h"
#include "vector"
 
#include <iostream>
#include <fstream>
#include "src/util/NumType.h"
#include "src/FullSystem/Residuals.h"
#include "src/FullSystem/HessianBlocks.h"
#include "src/util/FrameShell.h"
#include "src/util/IndexThreadReduce.h"
#include "src/OptimizationBackend/EnergyFunctional.h"
#include "src/FullSystem/PixelSelector2.h"
...
public:
	...
	FullSystem(const std::map<int, SE3>& id_to_SE3, const bool use_pre_calc_traj = false, const bool fix_traj = false);
	virtual ~FullSystem();
